...
public class ListaCircular {
	...
	/**
	 * Inserta un nuevo nodo despues de otro, ubicado por el valor
	 * que contiene
	...
	public void insertarPorReferencia(int referencia, int valor)
	{
		...
		if(!esVacia())
		{
			//Coonsulta si el valor existe en la lista
			...
			if(aux == ultimo)
			{
				...
				//Enlaza el nnuevo nodo después del nodo de referencia
				aux.setSiguiente(nuevo);
